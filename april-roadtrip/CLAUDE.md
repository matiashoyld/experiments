...
Tioga Pass (Hwy 120 East) does not open until late May. All Sierra passes (Ebbetts, Sonora, Monitor) confirmed closed on Caltrans as of March 3, 2026.

### Sequoia — RV is 21ft, ALL ROADS ACCESSIBLE
At 21ft, both RVs clear the 22ft Generals Highway limit. You can drive directly to Giant Forest, Moro Rock, and use Potwisha campground. Enter via either Hwy 198 (Ash Mountain) or Hwy 180 (Big Stump).

### No Hookups Inside National Parks
Neither Yosemite nor Sequoia have any electric/water/sewer hookups at campgrounds. Plan to be fully self-contained or camp at private RV parks outside the parks.

### April Weather
- Yosemite Valley: milder, 40s-60s°F during the day
- Sequoia Potwisha (2,100ft): warm, 50s-70s°F days
- Sequoia Azalea/Grant Grove (6,500ft): cold, lows in 20s-30s°F
- Carry tire chains — required by law during chain controls

### RV Electrical
- Liberty Lodge is Class B (Sprinter van base) — almost certainly **30 amp** shore power
- Confirm exact amp with Roadsurfer at pickup — all campgrounds on our list have 30 amp ✓

## Recommended Itinerary

| Day | Date | Plan | Campsite |
|-----|------|------|----------|
...
**Booked: Yosemite Pines RV Resort & Family Lodging**
- 2 x Premium Back-In RV sites, Apr 4–7 (3 nights)
- Confirmation #R00000002163 / Invoice #I00000004293
- Total: $502.80 + $11.24 booking fee = **$514.04** (card ending 3818)
- Rate: $82 first night, $69/night thereafter per site
- Check-in 12pm, check-out 11am
- Address: 20450 Old Highway 120, Groveland, CA 95321 — ~75 min to Valley via Hwy 120
- Cancellation: $25/site fee if cancelled 2+ weeks out; 50% camp credit if 1–2 weeks, balance forfeited; less than 1 week = full forfeiture
- T&Cs accepted Mar 16, 2026 (PDF on file)
- No hookups in-valley; drive in daily. FCFS sites (Wawona, Hodgdon) still possible as bonus on arrival.

**Exhausted options:**
- ~~Indian Flat RV Park~~ — FULL for Apr 4-6 (RV hookup sites). Tent sites only.
- ~~KOA Yosemite-Mariposa (Midpines)~~ — CLOSED permanently. Converted to AutoCamp glamping.
- ~~Bagby Campground~~ — FULL for Apr 4-7.
- ~~Yosemite Westlake (Coulterville)~~ — 1hr to Valley, bad leveling reviews, Airbnb-only. Skip.

**In-park FCFS bonus (no hookups, no online booking before Apr 15):**
- [ ] **Wawona Campground** — FCFS Apr 4-14. 93 sites, $36/night, 35ft max. 27mi/45min from Valley. Arrive before 10am.
- [ ] **Hodgdon Meadow** — FCFS before Apr 15. 105 sites, $36/night, 35ft max.
- [ ] **Upper Pines** — may be closed Mar 30–Apr 9 for hazard trees. Call (209) 372-8502 to confirm.

---

### ✅ SEQUOIA (Nights of Apr 7-8, 2 nights) — BOOKED

**Booked: Three Rivers Hideaway**
- 2 adjacent 30-amp full hookup RV sites, Apr 7–9 (2 nights)
- $69/night per site (2 guests), $2/extra guest — **no charge until arrival**
- Confirmed by Melissa via email (Mar 12, 2026)
- Check-in after 1pm, check-out 11am
- Address: 43365 Sierra Dr. (Hwy 198), Three Rivers, CA 93271 — 3.5mi from Ash Mountain entrance
- Only 30 amp available (not 50 amp)
- River access is safe — "built for floods" per Melissa
- Cancellation: free up to 48hrs before arrival; 1-night penalty within 48hrs

**In-park options (unavailable):**
- ~~Potwisha Campground~~ — FULL for Apr 7-9
- ~~Lodgepole Campground~~ — FULL for Apr 7-9
- [ ] **Azalea Campground (Kings Canyon)** — Shows "CAMPSITE CLOSED". Likely snow-closed at 6,500ft. Call (559) 565-4357 to confirm.
...
## Booking Action Items (Updated March 15)
...
5. **CALL (559) 565-4357** — confirm if Azalea (Kings Canyon) is snow-closed
...
| What | Number |
|------|--------|
| Yosemite Pines RV Resort | (209) 962-7690 |
| Indian Flat RV Park | (209) 379-2339 |
| Yosemite Campground Office | (209) 372-8502 |
| Yosemite Road Conditions | (209) 372-0200 (then 1, 1) |
| Three Rivers Hideaway | (559) 561-4413 |
| Three Rivers Hideaway (email) | info@threerivershideaway.com |
| Sequoia Campground & Lodge | (559) 561-4424 |
| Sequoia RV Ranch | (559) 561-4333 |
...
| Carmel by the River RV Resort | (831) 624-9329 |
| Moss Landing KOA | (831) 633-6800 |
| Marina Dunes RV Park | (831) 384-6914 |
| Yanks RV Resort | (831) 740-8007 |
| Santa Cruz Harbor RV Park | (831) 475-3279 |
| Beach RV Pleasure Point | beachrv.sc |
| New Brighton State Beach | (800) 444-7275 |
...
## RV Entry Routes (RV-safe)
- **Into Yosemite:** Hwy 140 (El Portal / Arch Rock entrance) — no tunnels, RV-friendly, lowest elevation
- **Into Sequoia:** Hwy 198 (Ash Mountain entrance) — at 21ft you clear ALL restrictions on Generals Highway
- **Alt Sequoia:** Hwy 180 East from Fresno (Big Stump entrance) — wider road, access to Grant Grove
...
- Warm layers, hats, gloves (freezing nights at elevation)
- Extra blankets/sleeping bags for kids
- Propane (fill before leaving SF)
- Full water tanks (no hookups in parks)
- Bear-safe food storage (food must be inside RV with doors/windows closed)
- Stroller with off-road wheels for trail walks
- 30-amp shore power adapter (confirm with Roadsurfer at pickup)

## Notes on Dump Stations
A dump station is a shared facility where you empty the RV's black water tank (toilet) and gray water tank (sink/shower). It's separate from the campsite. Sites listed as "Water & Electric" (no sewer) will have a dump station elsewhere in the campground. For 1-2 night stays, tanks won't fill up — dump before leaving each stop.

## Project Structure
- `CLAUDE.md` — this file, trip overview and booking tracker
- `emails/three-rivers-hideaway.md` — email draft sent to Three Rivers Hideaway
- `research/` — detailed research notes per destination

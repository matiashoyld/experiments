...
export const WORD_SETS: { sets: number[]; words: WordEntry[] }[] = [
  ...
  {
    sets: [1, 2], // adding i, n, m, d
    words: [
      { word: 'man', phonemes: ['m', 'a', 'n'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'sit', phonemes: ['s', 'i', 't'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'pin', phonemes: ['p', 'i', 'n'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'dim', phonemes: ['d', 'i', 'm'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'tip', phonemes: ['t', 'i', 'p'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'nap', phonemes: ['n', 'a', 'p'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'tan', phonemes: ['t', 'a', 'n'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'mat', phonemes: ['m', 'a', 't'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'map', phonemes: ['m', 'a', 'p'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'sip', phonemes: ['s', 'i', 'p'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'tin', phonemes: ['t', 'i', 'n'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'pan', phonemes: ['p', 'a', 'n'], type: 'cvc', requiredSets: [1, 2] },
      { word: 'pit', phonemes: ['p', 'i', 't'], type: 'cvc', requiredSets: [1, 2] },
  ...
  {
    sets: [1, 2, 3], // adding g, o, c, k
    words: [
      { word: 'got', phonemes: ['g', 'o', 't'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'cot', phonemes: ['c', 'o', 't'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'dog', phonemes: ['d', 'o', 'g'], type: 'cvc', requiredSets: [2, 3] },
      { word: 'kit', phonemes: ['k', 'i', 't'], type: 'cvc', requiredSets: [2, 3] },
      { word: 'mop', phonemes: ['m', 'o', 'p'], type: 'cvc', requiredSets: [1, 2, 3] },
      { word: 'cod', phonemes: ['c', 'o', 'd'], type: 'cvc', requiredSets: [2, 3] },
      { word: 'cog', phonemes: ['c', 'o', 'g'], type: 'cvc', requiredSets: [3] },
      { word: 'pig', phonemes: ['p', 'i', 'g'], type: 'cvc', requiredSets: [1, 2, 3] },
      { word: 'dig', phonemes: ['d', 'i', 'g'], type: 'cvc', requiredSets: [2, 3] },
      { word: 'cap', phonemes: ['c', 'a', 'p'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'cop', phonemes: ['c', 'o', 'p'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'gap', phonemes: ['g', 'a', 'p'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'gas', phonemes: ['g', 'a', 's'], type: 'cvc', requiredSets: [1, 3] },
      { word: 'not', phonemes: ['n', 'o', 't'], type: 'cvc', requiredSets: [1, 2, 3] },
      { word: 'nod', phonemes: ['n', 'o', 'd'], type: 'cvc', requiredSets: [2, 3] },
      { word: 'cat', phonemes: ['c', 'a', 't'], type: 'cvc', requiredSets: [1, 3] },
    ],
  },
  {
    sets: [1, 2, 3, 4], // adding ck, e, u, r
    words: [
      { word: 'red', phonemes: ['r', 'e', 'd'], type: 'cvc', requiredSets: [2, 4] },
      { word: 'pet', phonemes: ['p', 'e', 't'], type: 'cvc', requiredSets: [1, 4] },
      { word: 'run', phonemes: ['r', 'u', 'n'], type: 'cvc', requiredSets: [2, 4] },
      { word: 'cup', phonemes: ['c', 'u', 'p'], type: 'cvc', requiredSets: [1, 3, 4] },
      { word: 'sun', phonemes: ['s', 'u', 'n'], type: 'cvc', requiredSets: [1, 2, 4] },
      { word: 'duck', phonemes: ['d', 'u', 'ck'], type: 'cvc', requiredSets: [2, 4] },
      { word: 'sock', phonemes: ['s', 'o', 'ck'], type: 'cvc', requiredSets: [1, 3, 4] },
      { word: 'neck', phonemes: ['n', 'e', 'ck'], type: 'cvc', requiredSets: [2, 4] },
      { word: 'ten', phonemes: ['t', 'e', 'n'], type: 'cvc', requiredSets: [1, 2, 4] },
      { word: 'pen', phonemes: ['p', 'e', 'n'], type: 'cvc', requiredSets: [1, 2, 4] },
      { word: 'bed', phonemes: ['b', 'e', 'd'], type: 'cvc', requiredSets: [2, 4, 5] },
      { word: 'rug', phonemes: ['r', 'u', 'g'], type: 'cvc', requiredSets: [3, 4] },
